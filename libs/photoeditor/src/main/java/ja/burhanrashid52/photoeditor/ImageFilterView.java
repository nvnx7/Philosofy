...
class ImageFilterView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    void setSourceBitmap(Bitmap sourceBitmap) {
        //Log.i(TAG, "setSourceBitmap Called.");
    ...
    void setFilterEffect(PhotoFilter effect) {
        //Log.i(TAG, "setFilterEffect Called.");
        ...
        if (mCustomEffect != null) {
            ...
            switch (mCurrentEffect) {
                ...
                case BRIGHTNESS:
                    ...
                    mEffect.setParameter("ic_brightness", 2.0f);
                    break;
                case CONTRAST:
    ...
    private void applyEffect() {
        //Log.i(TAG, "applyEffect Called.");
        mEffect.apply(mTextures[0], mImageWidth, mImageHeight, mTextures[1]);
    }

    private void renderResult() {
        //Log.i(TAG, "renderResult Called.");
        if (mCurrentEffect != NONE || mCustomEffect != null) {
    ...
    public PhotoFilter getCurrentFilter() {
        //Log.i(TAG, "getCurrentFilter Called.");
